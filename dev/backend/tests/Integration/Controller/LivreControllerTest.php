...
class LivreControllerTest extends WebTestCase
{
    ...
    {
        $this->client->request('GET', '/api/livres', [], [], [
    ...
    {
        $this->client->request('GET', '/api/livres?titre=Prince', [], [], [
    ...
    {
        $this->client->request('POST', '/api/livres', [], [], [
    ...
    public function testDeleteLivreAdmin(): void
    {
        ...
        $this->client->request('DELETE', "/api/livres/$id", [], [], [
            'HTTP_AUTHORIZATION' => 'Bearer ' . $token,
        ]);
    ...
    {
        $this->client->request('DELETE', '/api/livres/1', [], [], [
            'HTTP_AUTHORIZATION' => 'Bearer ' . $this->getToken('bibliothecaire'),
        ]);
